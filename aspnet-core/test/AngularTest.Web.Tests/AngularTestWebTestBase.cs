...
using AngularTest.Models.TokenAuth;
...
{
    public abstract class AngularTestWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AngularTestWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AngularTestWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AngularTestDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AngularTestDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AngularTestDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AngularTestDbContext, Task<T>> func)
        {
            T result;
